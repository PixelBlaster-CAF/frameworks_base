package com.blaster.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.blaster.android.systemui.keyguard.BlasterKeyguardSliceProvider"), 1, 1)
        } else {
