...
public abstract class BlasterSystemUIModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(BlasterThemeOverlayController themeOverlayController);
